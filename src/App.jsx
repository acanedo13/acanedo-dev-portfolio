    ...
    <Box bg={bgColor} color={silverText} minH="100vh" transition="0.5s ease">
      ...
      <Container maxW="container.md" py={20}>
        ...
        <VStack spacing={20} align="stretch">
          ...
          <FadeIn>
            <Box as="header">
              ...
              <HStack spacing={8} mt={7} mb = {-4} color={mauveAccent}>
                ...
                <Tooltip label="GitHub" aria-label="GitHub Tooltip" openDelay={300}><Link href="https://github.com/acanedo13" isExternal aria-label="GitHub" _hover={{ color: headingColor }} style={{ transform: 'translateX(6px)' }}><FaGithub size="24px" /></Link></Tooltip>
          ...
          <FadeIn>
            <Box as="section">
              <Text fontSize="sm" fontWeight="mono" color={mauveAccent} mt= {10} mb={10} letterSpacing="widest"sx={{"::before": { content: '"root@adriana:~# "' }, "::after": { content: '"_"', animation: "blink 1s infinite" }}}>CERTIFICATIONS</Text>
                <style>{`
                @keyframes blink { 50% { opacity: 0; } }
              `}</style>
